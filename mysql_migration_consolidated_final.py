...
class FinalConsolidatedMySQLMigration:
    ...
    def create_all_tables(self):
        ...
        tables = {
            ...
            # 10. User Warehouse Assignments - Admin assigns from/to warehouses to users
        ...
        try:
            with self.connection.cursor() as cursor:
                cursor.execute('''
                    ...
                    (id, name, description, branch_code, branch_name, address, phone, email, manager_name, is_active, is_default)
            ...
            try:
                ...
                with self.connection.cursor() as cursor:
                    cursor.execute('''
                        ...
                        (username, email, password_hash, first_name, last_name, role, branch_id, branch_name, default_branch_id, is_active, permissions)
